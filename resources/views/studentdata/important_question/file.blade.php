        ...
        <div class="mt-8  rounded border-b-4 border-gray-300">
            ...
            @foreach ($important as $i)
                ...
                <div class="flex flex-wrap items-center text-gray-700 border-t-2 border-l-4 border-r-4 border-gray-300">
                    ...
                    <div class="w-3/12 px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight"><strong>{{ $i->paper_name }}</strong></div>
                    <div class="w-3/12 px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight"><strong><a download href="{{ asset('Uploads/Files/ImportantQuestion/'.$i->file_name) }}"><i class="fa fa-download"></i></a></strong></div>
